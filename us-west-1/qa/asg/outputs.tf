output "key_name" { 
    value = module.aws_asg.key_name 
}

output "vpc_cidr" {
    value = module.aws_asg.vpc_cidr
}

output "vpc_id" {
    value = module.aws_asg.vpc_id
}

output "vpc_zone_identifier" {
    value = module.aws_asg.vpc_zone_identifier
}

output "private_server_ami" {
    value = module.aws_asg.private_server_ami
}

output "user_data" {
    value = module.aws_asg.user_data
}
